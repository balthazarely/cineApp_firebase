<template>
  <div class="hero">
    ...
    <div v-if="currentUserUID == false" class="container">
      <div class="columns mt-5 is-centered">
        <div class="column is-half is-multiline  is-mobile  is-variable">
          If you would like to record movies to your journal, please register an
          account with us. With your journal, you can record when you watch
          movies, rate them, and write your own notes.
        </div>
      </div>
    </div>
...
.movie-theatre-wrapper
  ...
  background-image: linear-gradient(rgba(1, 40, 68 , .8), rgba(1, 40, 68 , .8)),  url("../assets/shinning.jpg")
  display: flex
  justify-content: center
</style>

<template>
  <div class="hero">
    ...
    <div v-if="currentUserUID == false" class="container">
      <div class="mt-5">
        If you would like to save movies to your watchlist, please register an
        account with us.
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    addToJournal(newId, id, newTitle, poster_path, date_added) {
...
.movie-theatre-wrapper
  ...
  background-image: linear-gradient(rgba(1, 40, 68 , .8), rgba(1, 40, 68 , .8)),  url("../assets/goodfellas.jpg")
  display: flex
  justify-content: center
  align-items: center
</style>
